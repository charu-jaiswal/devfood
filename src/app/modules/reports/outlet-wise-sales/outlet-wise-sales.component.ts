...
import { OutletWiseSalesServices } from './outlet-wise-sales.services';
import { Status, PaymentType, OrderType } from '../../../shared/common';
import { FirestoreService } from '../../../core/firestore.service';
import { ReportsFirePath, OutletFirePath, OutletCateFirePath } from '../../firestore.path';
...
@Component({
  selector: 'app-outlet-wise-sales',
  templateUrl: './outlet-wise-sales.component.html',
  styleUrls: ['./outlet-wise-sales.component.css'],
})
export class OutletWiseSalesComponent implements OnInit {
      ...
      this.outletWiseSalesServices.getOutlet(this.dataPost).subscribe((response: any) => {
        ...
        if (result.status) {
          if (result.data !== undefined) {
            this.outletWiseSales = result.data;
