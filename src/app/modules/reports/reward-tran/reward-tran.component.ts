...
import { RewardTransListService } from './reward-tran.services';
...
@Component({
  selector: 'brand-reward-tran',
  templateUrl: './reward-tran.component.html',
  styleUrls: ['./reward-tran.component.css'],
})
export class RewardTranListComponent implements OnInit {
  reportsList: any;
  response: any = {
    limit: 0,
    page: 0,
  ...
  constructor(
    private reportListService: RewardTransListService,
  ...
  loadList() {
    ...
    this.loading = true;
    this.reportListService.getRewardTranListData(this.dataPost).subscribe((response: any) => {
